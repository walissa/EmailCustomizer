...
namespace BizTalkComponents.Utils
{
    ...
    { 
        ...
        public static readonly string ContentType = SystemProperties.GetFullyQualifiedName(new ContentType());
        public static readonly string IsMultiPartRelated = SystemProperties.GetFullyQualifiedName(new MIME.IsMultipartRelated());
        public static readonly string ContentDescription = SystemProperties.GetFullyQualifiedName(new MIME.ContentDescription());
        public static readonly string ContentTransferEncoding = SystemProperties.GetFullyQualifiedName(new MIME.ContentTransferEncoding());
